...
// 1. Tambahkan CloseButton di import
import { Container, Card, Form, Button, CloseButton, Alert } from 'react-bootstrap';
import Image from 'next/image';
import Link from 'next/link';
// (Opsional) Jika Anda ingin tombol 'X' mengarahkan ke homepage
// import { useRouter } from 'next/navigation'; 

// --- Path Gambar Dekoratif (sesuai path baru Anda) ---
const yellowBrickImg = '/images/studs.png';
const redBrickImg = '/images/brickclean.png';
const minifigureImg = '/images/legoman.png';

// 2. Ganti nama fungsi agar sesuai file
export default function RegisterPage() {
  const [username, setUsername] = useState(''); // 3. Tambahkan state username
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const [confirmPassword, setConfirmPassword] = useState(''); // 4. Tambahkan state confirmPassword
  const [error, setError] = useState(''); // State untuk error
  
  // const router = useRouter(); // (Opsional)

  // 5. Perbaiki tipe event dan logika submit
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Contoh: panggil API register, dll.
  };
    ...
    <main>
      ...
      >
        ...
        <Image
          ...
          style={{ top: '10%', left: '15%', transform: 'rotate(30deg)', opacity: 0.9, zIndex: 1 }}
        />
        <Image
          src={redBrickImg}
          alt="Red brick"
          ...
          height={100}
          className="position-absolute d-none d-md-block"
          style={{ bottom: '5%', left: '10%', transform: 'rotate(-5deg)', zIndex: 1 }}
        />
        <Image
          src={minifigureImg}
          alt="Minifigure"
          ...
          style={{ bottom: '0%', right: '10%', transform: 'rotate(10deg)', zIndex: 1 }}
        />
        ...
        >
          {/* 7. Tambahkan CloseButton kembali */}
          <CloseButton 
            style={{ 
              position: 'absolute', 
              top: '1.5rem', 
          ...
          <Card.Body className="p-4 p-md-5">
            ...
            <Form onSubmit={handleSubmit}>
              ...
              {/* 9. TAMBAHKAN: Field Confirm Password */}
              ...
              {/* 10. HAPUS: Link "Forgot Password?" sudah dihapus */}
