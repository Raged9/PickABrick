...
import Link from 'next/link'; // Penting untuk link di Navbar/Footer
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body>
        {/* Style Global dipindahkan ke sini */}
        <style jsx global>{`
          .bg-yellow {
          ...
          .hero-section::before {
            ...
            right: 0;
            bottom: 0;
            background-color: rgba(0,0,0,0.3); /* Opsional: overlay gelap */
            z-index: 0;
          }
          .hero-content {
            position: relative;
        ...
        {/* Ini adalah tempat semua 'page.tsx' Anda akan dirender */}
        <main>
          {children}
        </main>
